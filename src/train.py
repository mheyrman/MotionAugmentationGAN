...
lambda_gp = 5  # Gradient penalty lambda hyperparameter
...
def train(num_epochs):
    ...
    optimizer_G = torch.optim.Adam(generator.parameters(), lr=5e-5, betas=(0, 0.9))
    optimizer_D = torch.optim.Adam(discriminator.parameters(), lr=5e-5, betas=(0, 0.9))
